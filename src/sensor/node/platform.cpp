...
std_msgs::Int32MultiArray angular_velocity;
...
void angular_velocity()
{
    ...
    angular_velocity[0] = (roll - roll_prev) / dt;
    angular_velocity[1] = (pitch - pitch_prev) / dt;
    angular_velocity[2] = (yaw - yaw_prev) / dt;
    platform_angular_velocity.publish(angular_velocity);
}
...
int main(int argc,char **argv)
{
    ...
    ros::Publisher platform_angular_velocity = nh.advertise<std_msgs::Float32MultiArray>
